...
class Bloks(Kubs):
    def __init__(self, krasa, malas_garums,forma,kubu_skaits):
        ...
        if forma not in iespejamas_vertibas: #pārbauda vai self.forma (dotās formas vērtība) sakrīt šajās prasībās.
            self.derigums = "nederīgs 0" #atgriež nederīgs 0  ,ja neatbilst
                
        else:
            self.derigums ="derīgs 1" #atgriež derīgs 1 , ja atbilst
    ...
    def mainit_formu(self,jauna_forma):
        ...
        if jauna_forma not in iespejamas_vertibas: #pārbauda vai self.forma (dotās formas vērtība) sakrīt šajās prasībās.
            self.derigums = "nederīgs 0" #atgriež nederīgs 0  ,ja neatbilst
...
print(f"{oranzs3.nosaukums} {oranzs3.tilpums()} {oranzs3.derigums}")
print("***")
print("Zils objekts:")
...
if zils5.forma in iespejamas_vertibas:
    print(f"{zils5.nosaukums} {zils5.derigums}") #pārbauda vai atbilst nosacijumiem
else:
    print("Forma neatbils nosacījumiem")
    print(f"{zils5.nosaukums} {zils5.derigums}")
print("***")

zils5.mainit_formu(12)
print("Mainīta forma:")
print(f"{zils5.nosaukums} {zils5.derigums}") 
print("***")